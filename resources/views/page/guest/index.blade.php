    ...
    guests.data.forEach(guest => {
        ...
        $(`#tableGroupList [group-id="${guest.group.id}"] table tbody`).append(`
                <tr>
                    ...
                    <td style="vertical-align: middle;"><a href="/guest?guest_id=${guest.guest_id}" target="_blank">${guest.guest_id}</a></td>
                    <td style="vertical-align: middle;"><a href="/guest?guest_id=${guest.guest_id}" target="_blank">${guest.fullname}</a></td>
